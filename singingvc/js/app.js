...
var _testing = false;
var loader_gif = '<img src="/textlessvc/gifs/loader.gif" style="width: 50px; height: 50px;">';
...
for(var row = 0; row < total_examples; row ++){
    ...
    var conversionTypeTd = "<td><select class='conversionTypeSelector' id='conversionTypeSelect_" + row + "'><option value='mimic'>Mimic</option><option value='adapt'>Adapt</option></select></td>";
